...
@test "[$TEST_FILE] Create Elasticms Super Admin user." {
  ...
  assert_output -r ".*\[OK\] Role \"ROLE_API\" has been added to user \"${BATS_ELASTICMS_ADMIN_USERNAME}\". This change will not apply until the user logs out and back in again."
  ...
  assert_output -r ".*\[OK\] Role \"ROLE_COPY_PASTE\" has been added to user \"${BATS_ELASTICMS_ADMIN_USERNAME}\". This change will not apply until the user logs out and back in again."
  ...
  assert_output -r ".*\[OK\] Role \"ROLE_ALLOW_ALIGN\" has been added to user \"${BATS_ELASTICMS_ADMIN_USERNAME}\". This change will not apply until the user logs out and back in again."
  ...
  assert_output -r ".*\[OK\] Role \"ROLE_FORM_CRM\" has been added to user \"${BATS_ELASTICMS_ADMIN_USERNAME}\". This change will not apply until the user logs out and back in again."
  ...
  assert_output -r ".*\[OK\] Role \"ROLE_TASK_MANAGER\" has been added to user \"${BATS_ELASTICMS_ADMIN_USERNAME}\". This change will not apply until the user logs out and back in again."
